...
// Run the code when the DOM is ready
    ...
    function pieChart() {
        ...
        function init() {
            ...
            if ( canvas === null || typeof canvas.getContext === 'undefined'  ) return;
            ...
            $('#chartData td').each(function () {
                ...
                currentCell++;
                if (currentCell  % 3 != 0 && currentCell % 2 != 0 ) {
                    currentRow++;
        ...
        function startPullOut(slice) {
            ...
            var labelCell = $('#chartData td:eq(' + (slice * 3) + ')');
            var valueCell = $('#chartData td:eq(' + (slice * 3 + 1) + ')');
            var valueCell2 = $('#chartData td:eq(' + (slice * 3 + 2) + ')');
            labelCell.addClass('highlight');
            valueCell.addClass('highlight');
            valueCell2.addClass('highlight');
        }
